...
func (c *bookServiceClient) ListBooks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListBooksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedBookServiceServer) ListBooks(context.Context, *emptypb.Empty) (*ListBooksResponse, error) {
